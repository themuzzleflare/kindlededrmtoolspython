...
if iswindows:
    ...
    def getDBfromFile(kInfoFile):
        ...
        namehashmap = {encode_hash(n, testMap8): n for n in names}
        # print(namehashmap)
        DB = {}
        ...
        cleartext = unprotect_header_data(encryptedValue)
        ...
        if len(DB) > 6:
            ...
            print("Decrypted key file using IDString '{0:s}' and UserName '{1:s}'".format(GetIDString(),
                                                                                          GetUserName().decode(
                                                                                              'utf-8')))
        else:
    ...
    def getDBfromFile(kInfoFile):
        ...
        for IDString in IDStrings:
            ...
            try:
                ...
                while len(items) > 0:
                    ...
                    keyname = b'unknown'
                    for name in names:
                        if encode_hash(name, testMap8) == keyhash:
                            keyname = name
                            break
        ...
        if len(DB) > 6:
            # store values used in decryption
            print("Decrypted key file using IDString '{0:s}' and UserName '{1:s}'".format(IDString.decode('utf-8'),
                                                                                          GetUserName().decode(
                                                                                              'utf-8')))
